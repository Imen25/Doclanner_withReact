...
import Leadparag from './components/leadParag';
...
function App() {
  let menu = [{ item: "About us", link: "#about" }, { item: "Career", link: "#career" }, {
    item: "Departments", link: "#departments", subitem: [{ item: "Marketing & PR", link: "/department?dep=marketing" },
    { item: "Customer Success & Sales", link: "/department?dep=customer" }, { item: "IT, Product, Design & UX", link: "/department?dep=it" },
    { item: "Finance & Administration", link: "/department?dep=finance" }, { item: "HR & more", link: "/department?dep=hr" }]
  }]

  let parag = ["We want patients to find the perfect doctor and book an appointment in the most easy way. The patient journey should be enjoyable, and that's why we are always next to them: to help them find the best possible care. Anytime, anywhere.",
  ...
  return (
    <div className="App">
      ...
      <div className="lead_section">
        ...
        <Leadparag desc={parag} />
      </div>
      <Serviceitem serv={services_item} />
      <div className="brand_list">
        <h1>
          We are a global company <br /> with local culture</h1>
        <Brands list_brand={brands} />
      </div>
      <div className="stats_services">
        <div>
          ...
          <img src="https://www.docplanner.com/img/logo.png" alt=""></img>
        </div>
        <Stats stat_item={stat_arr} />
      </div>
      <div className="offices">
        <div className="offices_item">
        ...
        <Office offic_arr={office_arr} />
      </div>
      <hr className="footer_section"/>
      <Footer foo={foo_arr} />
    </div>
  );
}
